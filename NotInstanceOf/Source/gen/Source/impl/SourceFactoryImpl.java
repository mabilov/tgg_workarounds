...
public class SourceFactoryImpl extends EFactoryImpl implements SourceFactory {
	...
	public EObject create(EClass eClass) {
		...
		case SourcePackage.ELEMENT_TYPE_A:
			return createElementTypeA();
		case SourcePackage.ELEMENT_TYPE_B:
			return createElementTypeB();
		case SourcePackage.ELEMENT_TYPE_C:
			return createElementTypeC();
		default:
	 ...
	 * @generated
	 */
	public ElementTypeA createElementTypeA() {
		ElementTypeAImpl elementTypeA = new ElementTypeAImpl();
		return elementTypeA;
	}
	 ...
	 * @generated
	 */
	public ElementTypeB createElementTypeB() {
		ElementTypeBImpl elementTypeB = new ElementTypeBImpl();
		return elementTypeB;
	}
	 ...
	 * @generated
	 */
	public ElementTypeC createElementTypeC() {
		ElementTypeCImpl elementTypeC = new ElementTypeCImpl();
		return elementTypeC;
	}
