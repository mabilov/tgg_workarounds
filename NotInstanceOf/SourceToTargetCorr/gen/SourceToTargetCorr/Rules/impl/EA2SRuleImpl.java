...
public class EA2SRuleImpl extends AbstractRuleImpl implements EA2SRule {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, ElementTypeA e, SourceModel sm) {
		// initial bindings
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ElementTypeA e = (ElementTypeA) result1_bindingAndBlack[0];
		...
		Object[] result1_green = EA2SRuleImpl.pattern_EA2SRule_1_1_greenBBFFB(
				e, tm, csp);
		Step s = (Step) result1_green[2];
		E2S e2S = (E2S) result1_green[3];

		// collect translated elements
		Object[] result2_black = EA2SRuleImpl.pattern_EA2SRule_1_2_blackBBB(e,
				s, e2S);
		...
		Object[] result2_green = EA2SRuleImpl.pattern_EA2SRule_1_2_greenFBBB(e,
				s, e2S);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = EA2SRuleImpl
				.pattern_EA2SRule_1_3_blackBBBBBBB(ruleresult, e, sm, tm,
						sm2Tm, s, e2S);
		...
		EA2SRuleImpl.pattern_EA2SRule_1_3_greenBBBBBBFFFF(ruleresult, e, sm,
				tm, s, e2S);
		...
		// register objects
		EA2SRuleImpl.pattern_EA2SRule_1_5_expressionBBBBBBBB(this, ruleresult,
				e, sm, tm, sm2Tm, s, e2S);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		ElementTypeA e = (ElementTypeA) result2_binding[0];
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, ElementTypeA e,
			SourceModel sm) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, ElementTypeA e,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			ElementTypeA e, SourceModel sm, TargetModel tm, SM2TM sm2Tm) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public boolean checkTypes_FWD(Match match) {
		return true && match.getObject("e").eClass()
				.equals(Source.SourcePackage.eINSTANCE.getElementTypeA());
	}
	...
	public boolean isAppropriate_BWD(Match match, TargetModel tm, Step s) {
		// initial bindings
		Object[] result1_black = EA2SRuleImpl.pattern_EA2SRule_10_1_blackBBBB(
				this, match, tm, s);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [initial bindings] failed."
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = EA2SRuleImpl
				.pattern_EA2SRule_10_2_bindingAndBlackFBBBB(this, match, tm, s);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [Solve CSP] failed."
							+ " Variables: " + "[this] = " + this + ", "
		...
		if (EA2SRuleImpl.pattern_EA2SRule_10_3_expressionFBB(this, csp)) {
			...
			// collect elements to be translated
			Object[] result4_black = EA2SRuleImpl
					.pattern_EA2SRule_10_4_blackBBB(match, tm, s);
			if (result4_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect elements to be translated] failed."
								+ " Variables: " + "[match] = " + match + ", "
			...
			EA2SRuleImpl.pattern_EA2SRule_10_4_greenBBBF(match, tm, s);
			// EMoflonEdge tm__s____steps = (EMoflonEdge) result4_green[3];

			// collect context elements
			Object[] result5_black = EA2SRuleImpl
					.pattern_EA2SRule_10_5_blackBBB(match, tm, s);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect context elements] failed."
								+ " Variables: " + "[match] = " + match + ", "
			...
			// register objects to match
			EA2SRuleImpl.pattern_EA2SRule_10_6_expressionBBBB(this, match, tm,
					s);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = EA2SRuleImpl
				.pattern_EA2SRule_11_1_bindingAndBlackFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [perform transformation] failed."
		...
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = EA2SRuleImpl.pattern_EA2SRule_11_1_greenFBBFB(
				sm, s, csp);
		ElementTypeA e = (ElementTypeA) result1_green[0];
		E2S e2S = (E2S) result1_green[3];

		// collect translated elements
		Object[] result2_black = EA2SRuleImpl.pattern_EA2SRule_11_2_blackBBB(e,
				s, e2S);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [collect translated elements] failed."
		...
		Object[] result2_green = EA2SRuleImpl.pattern_EA2SRule_11_2_greenFBBB(
				e, s, e2S);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = EA2SRuleImpl
				.pattern_EA2SRule_11_3_blackBBBBBBB(ruleresult, e, sm, tm,
						sm2Tm, s, e2S);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [bookkeeping for edges] failed."
		...
		EA2SRuleImpl.pattern_EA2SRule_11_3_greenBBBBBBFFFF(ruleresult, e, sm,
				tm, s, e2S);
		// EMoflonEdge sm__e____elements = (EMoflonEdge) result3_green[6];
		// EMoflonEdge tm__s____steps = (EMoflonEdge) result3_green[7];
		// EMoflonEdge e2S__e____source = (EMoflonEdge) result3_green[8];
		...
		// perform postprocessing story node is empty
		// register objects
		EA2SRuleImpl.pattern_EA2SRule_11_5_expressionBBBBBBBB(this, ruleresult,
				e, sm, tm, sm2Tm, s, e2S);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach core match
		Object[] result2_binding = EA2SRuleImpl
				.pattern_EA2SRule_12_2_bindingFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException("Binding in node core match failed."
					+ " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : EA2SRuleImpl
				.pattern_EA2SRule_12_2_blackFBFBB(tm, s, match)) {
			SourceModel sm = (SourceModel) result2_black[0];
			SM2TM sm2Tm = (SM2TM) result2_black[2];
			// ForEach find context
			for (Object[] result3_black : EA2SRuleImpl
					.pattern_EA2SRule_12_3_blackBBBB(sm, tm, sm2Tm, s)) {
				Object[] result3_green = EA2SRuleImpl
						.pattern_EA2SRule_12_3_greenBBBBFFFF(sm, tm, sm2Tm, s);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				...
				// solve CSP
				Object[] result4_bindingAndBlack = EA2SRuleImpl
						.pattern_EA2SRule_12_4_bindingAndBlackFBBBBBB(this,
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_0(
		...
		for (Object[] result2_black : EA2SRuleImpl
				.pattern_EA2SRule_20_2_blackFFB(_edge_elements)) {
			ElementTypeA e = (ElementTypeA) result2_black[0];
			...
			if (EA2SRuleImpl.pattern_EA2SRule_20_3_expressionFBBBB(this, match,
					e, sm)) {
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_0(
		...
		// ForEach test core match and DECs
		for (Object[] result2_black : EA2SRuleImpl
				.pattern_EA2SRule_21_2_blackFFB(_edge_steps)) {
	...
	public ModelgeneratorRuleResult generateModel(
		...
		Object[] result1_black = EA2SRuleImpl
				.pattern_EA2SRule_24_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [create result] failed."
							+ " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = EA2SRuleImpl.pattern_EA2SRule_24_1_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach is applicable core
		for (Object[] result2_black : EA2SRuleImpl
				.pattern_EA2SRule_24_2_blackFFFFBB(ruleEntryContainer,
						ruleResult)) {
			...
			Object[] result3_bindingAndBlack = EA2SRuleImpl
					.pattern_EA2SRule_24_3_bindingAndBlackFBBBBBB(this,
			...
			// check CSP
			if (EA2SRuleImpl.pattern_EA2SRule_24_4_expressionFBB(this, csp)) {
				// check nacs
				Object[] result5_black = EA2SRuleImpl
						.pattern_EA2SRule_24_5_blackBBB(sm, tm, sm2Tm);
				if (result5_black != null) {

					// perform
					Object[] result6_black = EA2SRuleImpl
							.pattern_EA2SRule_24_6_blackBBBB(sm, tm, sm2Tm,
									ruleResult);
					if (result6_black == null) {
						throw new RuntimeException(
					...
					EA2SRuleImpl.pattern_EA2SRule_24_6_greenFBBFFBB(sm, tm,
							ruleResult, csp);
					// ElementTypeA e = (ElementTypeA) result6_green[0];
		...
		return EA2SRuleImpl.pattern_EA2SRule_24_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
		case RulesPackage.EA2S_RULE___IS_APPROPRIATE_FWD__MATCH_ELEMENTTYPEA_SOURCEMODEL:
			return isAppropriate_FWD((Match) arguments.get(0),
					(ElementTypeA) arguments.get(1),
		...
		case RulesPackage.EA2S_RULE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_ELEMENTTYPEA_SOURCEMODEL:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(ElementTypeA) arguments.get(1),
					(SourceModel) arguments.get(2));
			return null;
		case RulesPackage.EA2S_RULE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_ELEMENTTYPEA_SOURCEMODEL:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(ElementTypeA) arguments.get(1),
					(SourceModel) arguments.get(2));
		case RulesPackage.EA2S_RULE___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.EA2S_RULE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ELEMENTTYPEA_SOURCEMODEL_TARGETMODEL_SM2TM:
		...
		case RulesPackage.EA2S_RULE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.EA2S_RULE___IS_APPROPRIATE_BWD__MATCH_TARGETMODEL_STEP:
		...
		case RulesPackage.EA2S_RULE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TARGETMODEL_STEP:
			registerObjectsToMatch_BWD((Match) arguments.get(0),
					(TargetModel) arguments.get(1), (Step) arguments.get(2));
			return null;
		case RulesPackage.EA2S_RULE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TARGETMODEL_STEP:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0),
					(TargetModel) arguments.get(1), (Step) arguments.get(2));
		case RulesPackage.EA2S_RULE___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.EA2S_RULE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_SOURCEMODEL_TARGETMODEL_SM2TM_STEP:
		...
		case RulesPackage.EA2S_RULE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.EA2S_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_0__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_0((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.EA2S_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_0__EMOFLONEDGE:
	...
	public static final Object[] pattern_EA2SRule_0_1_blackBBBB(EA2SRule _this,
			Match match, ElementTypeA e, SourceModel sm) {
		return new Object[] { _this, match, e, sm };
	}

	public static final Object[] pattern_EA2SRule_0_2_bindingFBBBB(
			EA2SRule _this, Match match, ElementTypeA e, SourceModel sm) {
	...
	public static final Object[] pattern_EA2SRule_1_1_bindingFFFFB(
		...
		if (tmpE instanceof ElementTypeA) {
			ElementTypeA e = (ElementTypeA) tmpE;
	...
	public static final Object[] pattern_EA2SRule_1_1_blackBBBBFBB(
			ElementTypeA e, SourceModel sm, TargetModel tm, SM2TM sm2Tm,
	...
	public static final Object[] pattern_EA2SRule_1_1_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_EA2SRule_1_1_binding != null) {
			ElementTypeA e = (ElementTypeA) result_pattern_EA2SRule_1_1_binding[0];
	...
	public static final Object[] pattern_EA2SRule_1_1_greenBBFFB(
			ElementTypeA e, TargetModel tm, CSP csp) {
	...
	public static final Object[] pattern_EA2SRule_1_2_blackBBB(ElementTypeA e,
			Step s, E2S e2S) {
		return new Object[] { e, s, e2S };
	}

	public static final Object[] pattern_EA2SRule_1_2_greenFBBB(ElementTypeA e,
			Step s, E2S e2S) {
	...
	public static final Object[] pattern_EA2SRule_1_3_blackBBBBBBB(
	...
	public static final Object[] pattern_EA2SRule_1_3_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject e, EObject sm, EObject tm,
	...
	public static final void pattern_EA2SRule_1_5_expressionBBBBBBBB(
			EA2SRule _this, PerformRuleResult ruleresult, EObject e,
			EObject sm, EObject tm, EObject sm2Tm, EObject s, EObject e2S) {
	...
	public static final Iterable<Object[]> pattern_EA2SRule_2_2_blackBBFFB(
			ElementTypeA e, SourceModel sm, Match match) {
	...
	public static final Object[] pattern_EA2SRule_2_3_greenBBBBFFFF(
			ElementTypeA e, SourceModel sm, TargetModel tm, SM2TM sm2Tm) {
	...
	public static final Object[] pattern_EA2SRule_10_1_blackBBBB(
			EA2SRule _this, Match match, TargetModel tm, Step s) {
		return new Object[] { _this, match, tm, s };
	}

	public static final Object[] pattern_EA2SRule_10_2_bindingFBBBB(
			EA2SRule _this, Match match, TargetModel tm, Step s) {
	...
	public static final Object[] pattern_EA2SRule_10_2_bindingAndBlackFBBBB(
			EA2SRule _this, Match match, TargetModel tm, Step s) {
		Object[] result_pattern_EA2SRule_10_2_binding = pattern_EA2SRule_10_2_bindingFBBBB(
				_this, match, tm, s);
	...
	public static final Object[] pattern_EA2SRule_10_4_blackBBB(Match match,
			TargetModel tm, Step s) {
		return new Object[] { match, tm, s };
	}

	public static final Object[] pattern_EA2SRule_10_4_greenBBBF(Match match,
			TargetModel tm, Step s) {
		EMoflonEdge tm__s____steps = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
	...
	public static final Object[] pattern_EA2SRule_10_5_blackBBB(Match match,
			TargetModel tm, Step s) {
		return new Object[] { match, tm, s };
	}
	...
	public static final void pattern_EA2SRule_10_6_expressionBBBB(
			EA2SRule _this, Match match, TargetModel tm, Step s) {
	...
	public static final Object[] pattern_EA2SRule_11_1_bindingFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_EA2SRule_11_1_blackBBBBFBB(
	...
	public static final Object[] pattern_EA2SRule_11_1_bindingAndBlackFFFFFBB(
			EA2SRule _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_EA2SRule_11_1_binding = pattern_EA2SRule_11_1_bindingFFFFB(isApplicableMatch);
		if (result_pattern_EA2SRule_11_1_binding != null) {
			SourceModel sm = (SourceModel) result_pattern_EA2SRule_11_1_binding[0];
			TargetModel tm = (TargetModel) result_pattern_EA2SRule_11_1_binding[1];
			SM2TM sm2Tm = (SM2TM) result_pattern_EA2SRule_11_1_binding[2];
			Step s = (Step) result_pattern_EA2SRule_11_1_binding[3];

			Object[] result_pattern_EA2SRule_11_1_black = pattern_EA2SRule_11_1_blackBBBBFBB(
					sm, tm, sm2Tm, s, _this, isApplicableMatch);
			if (result_pattern_EA2SRule_11_1_black != null) {
				CSP csp = (CSP) result_pattern_EA2SRule_11_1_black[4];
	...
	public static final Object[] pattern_EA2SRule_11_1_greenFBBFB(
			SourceModel sm, Step s, CSP csp) {
		ElementTypeA e = SourceFactory.eINSTANCE.createElementTypeA();
		E2S e2S = SourceToTargetCorrFactory.eINSTANCE.createE2S();
	...
	public static final Object[] pattern_EA2SRule_11_2_blackBBB(ElementTypeA e,
			Step s, E2S e2S) {
		return new Object[] { e, s, e2S };
	}

	public static final Object[] pattern_EA2SRule_11_2_greenFBBB(
			ElementTypeA e, Step s, E2S e2S) {
		PerformRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createPerformRuleResult();
	...
	public static final Object[] pattern_EA2SRule_11_3_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject e, EObject sm, EObject tm,
			EObject sm2Tm, EObject s, EObject e2S) {
		if (!e.equals(sm)) {
			if (!e.equals(tm)) {
	...
	public static final Object[] pattern_EA2SRule_11_3_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject e, EObject sm, EObject tm,
			EObject s, EObject e2S) {
		EMoflonEdge sm__e____elements = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
	...
	public static final void pattern_EA2SRule_11_5_expressionBBBBBBBB(
			EA2SRule _this, PerformRuleResult ruleresult, EObject e,
			EObject sm, EObject tm, EObject sm2Tm, EObject s, EObject e2S) {
	...
	public static final Object[] pattern_EA2SRule_12_2_bindingFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_EA2SRule_12_2_blackFBFBB(
	...
	public static final Iterable<Object[]> pattern_EA2SRule_12_3_blackBBBB(
			SourceModel sm, TargetModel tm, SM2TM sm2Tm, Step s) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_EA2SRule_12_3_greenBBBBFFFF(
			SourceModel sm, TargetModel tm, SM2TM sm2Tm, Step s) {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableMatch();
		EMoflonEdge tm__s____steps = TGGRuntimeFactory.eINSTANCE
	...
	public static final Object[] pattern_EA2SRule_12_4_bindingFBBBBBB(
			EA2SRule _this, IsApplicableMatch isApplicableMatch,
			SourceModel sm, TargetModel tm, SM2TM sm2Tm, Step s) {
	...
	public static final Object[] pattern_EA2SRule_12_4_bindingAndBlackFBBBBBB(
			EA2SRule _this, IsApplicableMatch isApplicableMatch,
			SourceModel sm, TargetModel tm, SM2TM sm2Tm, Step s) {
		Object[] result_pattern_EA2SRule_12_4_binding = pattern_EA2SRule_12_4_bindingFBBBBBB(
	...
	public static final Iterable<Object[]> pattern_EA2SRule_20_2_blackFFB(
			EMoflonEdge _edge_elements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final boolean pattern_EA2SRule_20_3_expressionFBBBB(
			EA2SRule _this, Match match, ElementTypeA e, SourceModel sm) {
	...
	public static final Object[] pattern_EA2SRule_21_2_black_nac_0BB(Step s,
			TargetModel tm) {
		for (TargetModel __DEC_s_steps_48733 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(s, TargetModel.class, "steps")) {
			if (!tm.equals(__DEC_s_steps_48733)) {
	...
	public static final Iterable<Object[]> pattern_EA2SRule_21_2_blackFFB(
		...
		if (tmpTm instanceof TargetModel) {
			...
			if (tmpS instanceof Step) {
				Step s = (Step) tmpS;
				if (tm.getSteps().contains(s)) {
					if (pattern_EA2SRule_21_2_black_nac_0BB(s, tm) == null) {
	...
	public static final Object[] pattern_EA2SRule_24_1_blackB(EA2SRule _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_EA2SRule_24_1_greenFF() {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableMatch();
	...
	public static final Object[] pattern_EA2SRule_24_2_black_nac_0BB(
	...
	public static final Object[] pattern_EA2SRule_24_2_black_nac_1BB(
	...
	public static final Object[] pattern_EA2SRule_24_2_black_nac_2BB(
	...
	public static final Iterable<Object[]> pattern_EA2SRule_24_2_blackFFFFBB(
			...
			for (EObject tmpSm2Tm : sm2TmList.getEntryObjects()) {
				if (tmpSm2Tm instanceof SM2TM) {
					...
					if (sm != null) {
						TargetModel tm = sm2Tm.getTarget();
						if (tm != null) {
							if (pattern_EA2SRule_24_2_black_nac_1BB(ruleResult,
									sm2Tm) == null) {
								if (pattern_EA2SRule_24_2_black_nac_0BB(
										ruleResult, sm) == null) {
									if (pattern_EA2SRule_24_2_black_nac_2BB(
											ruleResult, tm) == null) {
	...
	public static final Object[] pattern_EA2SRule_24_3_bindingFBBBBBB(
			EA2SRule _this, IsApplicableMatch isApplicableMatch,
			SourceModel sm, TargetModel tm, SM2TM sm2Tm,
			ModelgeneratorRuleResult ruleResult) {
	...
	public static final Object[] pattern_EA2SRule_24_3_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_EA2SRule_24_3_bindingAndBlackFBBBBBB(
			EA2SRule _this, IsApplicableMatch isApplicableMatch,
			SourceModel sm, TargetModel tm, SM2TM sm2Tm,
			ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_EA2SRule_24_3_binding = pattern_EA2SRule_24_3_bindingFBBBBBB(
				_this, isApplicableMatch, sm, tm, sm2Tm, ruleResult);
		if (result_pattern_EA2SRule_24_3_binding != null) {
			CSP csp = (CSP) result_pattern_EA2SRule_24_3_binding[0];

			Object[] result_pattern_EA2SRule_24_3_black = pattern_EA2SRule_24_3_blackB(csp);
			if (result_pattern_EA2SRule_24_3_black != null) {
	...
	public static final boolean pattern_EA2SRule_24_4_expressionFBB(
			EA2SRule _this, CSP csp) {
	...
	public static final Object[] pattern_EA2SRule_24_5_blackBBB(SourceModel sm,
			TargetModel tm, SM2TM sm2Tm) {
		return new Object[] { sm, tm, sm2Tm };
	}

	public static final Object[] pattern_EA2SRule_24_6_blackBBBB(
			SourceModel sm, TargetModel tm, SM2TM sm2Tm,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { sm, tm, sm2Tm, ruleResult };
	}

	public static final Object[] pattern_EA2SRule_24_6_greenFBBFFBB(
	...
	public static final ModelgeneratorRuleResult pattern_EA2SRule_24_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
