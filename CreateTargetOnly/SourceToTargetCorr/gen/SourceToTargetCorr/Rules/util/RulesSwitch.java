...
public class RulesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RulesPackage.CONTINUE_FIX_RULE: {
			ContinueFixRule continueFixRule = (ContinueFixRule) theEObject;
			T result = caseContinueFixRule(continueFixRule);
			if (result == null)
				result = caseAbstractRule(continueFixRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Continue Fix Rule</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Continue Fix Rule</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseContinueFixRule(ContinueFixRule object) {
		return null;
	}
