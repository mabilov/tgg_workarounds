 ...
 * @generated
 */
public class SourceToTargetCorrSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SourceToTargetCorrSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SourceToTargetCorrPackage.SM2TM: {
			SM2TM sm2TM = (SM2TM) theEObject;
			T result = caseSM2TM(sm2TM);
			if (result == null)
				result = caseAbstractCorrespondence(sm2TM);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SourceToTargetCorrPackage.E2S: {
			E2S e2S = (E2S) theEObject;
			T result = caseE2S(e2S);
			if (result == null)
				result = caseAbstractCorrespondence(e2S);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SourceToTargetCorrPackage.E2_SP: {
			E2Sp e2Sp = (E2Sp) theEObject;
			T result = caseE2Sp(e2Sp);
			if (result == null)
				result = caseAbstractCorrespondence(e2Sp);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>SM2TM</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>SM2TM</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSM2TM(SM2TM object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>E2S</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>E2S</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseE2S(E2S object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>E2 Sp</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>E2 Sp</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
